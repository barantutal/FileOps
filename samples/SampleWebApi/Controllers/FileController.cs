...
public class FileController : ControllerBase
{
    ...
    public FileOperationModel GenerateRandomFiles(bool? throwEx)
    {
        ...
        try
        {
            ...
            var file1 = _fileOpsManager.GenerateFile($"/Users/barantutal/Desktop/test1/file-{info1}.txt", Encoding.UTF8.GetBytes(info1));
            var file2 = _fileOpsManager.GenerateFile($"/Users/barantutal/Desktop/test1/file-{info2}.txt", Encoding.UTF8.GetBytes(info2));
                
            responseModel.FileInfos.Add(file1);
            responseModel.FileInfos.Add(file2);

            // Content will be 'info1' for both files
            var copiedFile = _fileOpsManager.CopyFile($"/Users/barantutal/Desktop/test1/file-{info1}.txt", $"/Users/barantutal/Desktop/test1/file-{info2}.txt");
